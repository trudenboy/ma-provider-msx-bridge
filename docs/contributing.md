...
- Logs from the MA server (`./scripts/test-server.sh log`)
...
3. Make your changes following the [coding standards](development.md#code-standards)
...
- [Architecture](architecture.md) — codebase structure and key flows
