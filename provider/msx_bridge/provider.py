...
class MSXBridgeProvider(PlayerProvider):
    ...
    async def handle_async_init(self) -> None:
        ...
        self.group_stream_mode = str(
            self.config.get_value(CONF_GROUP_STREAM_MODE, DEFAULT_GROUP_STREAM_MODE) or DEFAULT_GROUP_STREAM_MODE
        )
    ...
    async def get_or_register_player(
        ...
        output_format = str(
            self.config.get_value(CONF_OUTPUT_FORMAT, DEFAULT_OUTPUT_FORMAT) or DEFAULT_OUTPUT_FORMAT
        )
